...
public class CMStools {
     ...
     * рабочая директория
     */
    public static final String TEST_PATH = System.getProperty("user.dir") + SEPAR + ".." + SEPAR + "temp";
    ...
    public static final String SIGN_CERT_PATH = TEST_PATH + SEPAR + SIGN_KEY_NAME + CERT_EXT;
    ...
    public static final String SIGN_CERT_PATH_2012_256 = TEST_PATH + SEPAR + SIGN_KEY_NAME_2012_256 + CERT_EXT;
    ...
    public static final String SIGN_CERT_PATH_2012_512 = TEST_PATH + SEPAR + SIGN_KEY_NAME_2012_512 + CERT_EXT;
    ...
    public static final String RECIP_CERT_PATH = TEST_PATH + SEPAR + RECIP_KEY_NAME + CERT_EXT;
    ...
    public static final String RECIP_CERT_PATH_2012_256 = TEST_PATH + SEPAR + RECIP_KEY_NAME_2012_256 + CERT_EXT;
    ...
    public static final String RECIP_CERT_PATH_2012_512 = TEST_PATH + SEPAR + RECIP_KEY_NAME_2012_512 + CERT_EXT;
    ...
    public static final String DATA_FILE_PATH = TEST_PATH + SEPAR + DATA_FILE;
     ...
     * @throws Exception e
     */
    public static synchronized byte[] digestm(byte[] bytes, String digestAlgorithmName,
